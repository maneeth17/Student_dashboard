...
export default function Register({ goToLogin }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      console.error(err);
      const message = err?.response?.data?.message || err?.response?.data || "Registration failed. Username may already exist.";
      ...
      <Container maxWidth="sm">
        ...
        >
          <CardContent sx={{ p: { xs: 3, sm: 5 } }}>
            <Typography variant="h3" align="center" sx={{ fontWeight: 700, letterSpacing: 0.2 }}>
              University Dashboard Register
            </Typography>
            <Typography
              variant="body2"
              align="center"
            ...
            <Typography align="center" sx={{ mt: 3, color: "#cbd5e1" }}>
              ...
              <Button size="small" sx={{ ml: 1, fontWeight: 700 }} onClick={goToLogin}>
                Login
              </Button>
            </Typography>
          </CardContent>
